<template>
    <InnerCard icon="memory" title="Arbeitsspeicher">
        <div class="relative w-24 h-24 sm:w-28 sm:h-28">
            ...
            <div
                class="absolute inset-0 flex flex-col items-center justify-center leading-tight text-foreground"
            >
...
const percent = computed(() =>
    props.memory.total > 0
        ? Math.round((used.value / props.memory.total) * 100)
        : 0
)
